...
<body>
	<div class="page-wrapper">
		...
		<header class="header">
			<div class="header-top  text-uppercase" style="background-color:rgb(18,36,74)">
				<div class="container">
					<div class="header-right header-dropdowns ml-0 ml-sm-auto">
						<p class="top-message mb-0 mr-lg-5 pr-3 d-none d-sm-block text-white" >Welcome To Woza!</p>
						<div class="header-dropdown dropdown-expanded mr-3">
							<a href="#">Links</a>
							<div class="header-menu">
								<ul>
									<li class="text-white"><a href="{{route('about')}}">About</a></li>
									<li class="text-white"><a href="{{route('contact')}}">Contact</a></li>
									<li class="text-white"><a href="{{route('partner.signup')}}">Join Woza Partner</a></li>
								</ul>
							</div><!-- End .header-menu -->
			...
			<div class="header-middle text-dark">
				<div class="container">
					<div class="header-left col-lg-2 w-auto pl-0">
						...
						<a href="/" class="logo">
							 <span><img class="rounded-circle" src="{{asset('images/icon/woza.jpg')}}" alt="Porto Logo" width="75"></span>
						</a>
					</div><!-- End .header-left -->
							...
							<ul class="menu">
								...
								<li>
									...
									<ul>
										...
										<li><button form="signout" type="submit" class=" btn btn-md btn-primary ml-4" > <i class="fa fa-arrow-circle-right mr-2" aria-hidden="true"></i>
        ...
        @yield('content')
        <footer class="footer " style="background-color: rgb(18,36,74)">
						...
						<div class="col-lg-3 col-sm-6 pb-5 pb-sm-0">
							<div class="widget mb-2">
								...
								<ul class="contact-info m-b-4">
									<li>
										<span class="contact-info-label">Address:</span>Nairobi, Kenya
									</li>
									<li>
										<span class="contact-info-label">Phone:</span><a href="tel:">(123) 456-7890</a>
									</li>
									<li>
										<span class="contact-info-label">Email:</span> <a href="mailto:mail@example.com">woza@co.ke</a>
									</li>
								</ul>
								<div class="social-icons">
			...
			<div class="container">
				<div class="footer-bottom d-flex justify-content-between align-items-center flex-wrap">
					<p class="footer-copyright py-3 pr-4 mb-0">© Woza. {{now()->year}}. All Rights Reserved</p>
				</div>
			</div><!-- End .container -->
		</footer><!-- End .footer -->
		...
		<div class="modal-dialog" role="document">
		  <div class="modal-content">
			<div class="modal-body add-cart-box text-center">
				...
				<div class="form-group">
					<button type="submit" class=" address-btn btn btn-primary btn-md">Confirm Address</button>
