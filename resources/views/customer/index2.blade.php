...
@section('content')
<main class="main" style="background-color:rgb(227,95,33)">
    <div class="container mb-2">
        <div class="info-boxes-container row row-joined mb-2 font2" style="color: white !important">
            <div class="info-box info-box-icon-left col-lg-4">
                <i class="icon-shipping"></i>

                <div class="info-box-content">
                    <h4>AFFORDABLE & QUICK DELIVERY </h4>
                    <p class="text-body text-white"  style="color: white !important">Affordable delivery within few minutes </p>
            ...
            <div class="info-box info-box-icon-left col-lg-4">
                ...
                <div class="info-box-content">
                    ...
                    <p class="text-body text-white"  style="color: white !important">100% guarantee on quality of products and services</p>
                </div><!-- End .info-box-content -->
            </div><!-- End .info-box -->
            ...
            <div class="info-box info-box-icon-left col-lg-4">
                ...
                <div class="info-box-content">
                    ...
                    <p class="text-body text-white"  style="color: white !important">24/7 customer support and service.</p>
                </div><!-- End .info-box-content -->
            </div><!-- End .info-box -->
        </div>
            ...
            <div class="col-lg-9">
                <div class="home-slider owl-carousel owl-theme owl-carousel-lazy mb-2" data-owl-options="{
                    ...
                    <div class="home-slide  home-slide1 banner banner-md-vw banner-sm-vw" style="background-color: rgb(227,95,33)">
                            ...
                            <img class="owl-lazy slide-bg" src="{{asset('woza/assets/images/splash/splash'.$i.'.jpg')}}" 
                            data-src="{{asset('woza/assets/images/splash/splash'.$i.'.jpg')}}" alt="slider image">
                     
                       
                        <div class="banner-layer banner-layer-middle text-uppercase">
                            <h4 class=" text-white m-b-2 ">{{$item->description}}</h4>
                            <h2 class="m-b-3" style="color: rgb(227,95,33)">{{$item->title}}</h2>
                            <h3 class="text-white text-uppercase m-b-3">{{$item->category}}</h3>
                ...
                <div class="products-slider owl-carousel owl-theme dots-top m-b-1 pb-1 bg-white" >
                    @forelse ($shops->take(162) as $item)
                        <div class="product-default inner-quickview inner-icon bg-white rounded">
                            <figure>
                                ...
                                @endif
                                    ...
                                    <img class="rounded" src="{{asset('images/'.$item->icon)}}">
                                </a>
                            ...
                            <div class="product-details">
                                ...
                                <h2 class="product-title ml-5">
                                    @if (Cookie::get('name') === null)
                                    <a href="#address" data-toggle="modal" data-target="#address"> {{$item->title}}</a>
                                    @else
                                    <a href="{{route('categories',$item->title)}}"><h6>{{$item->title}}</h6> </a>
                                    @endif
                                </h2>
                ...
                <div class="products-slider owl-carousel owl-theme dots-top m-b-1 pb-1 w-100 bg-white">
                    @forelse ($services as $item)
                        <div class="product-default inner-quickview inner-icon bg-white rounded">
                            ...
                            <div class="product-details">
                                <div class="category-wrap ml-5">
                                    <div class="category-list">
                                        <a href="{{route('services',$item->title)}}" class="product-category ml-1 text-b"><strong>category</strong></a>
                                    </div>
                                </div>
                                <h2 class="product-title ml-5">
                                    <a href="{{route('services',$item->title)}}"><h6> {{$item->title}}</h6></a>
                                </h2>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="feature-box px-sm-3 feature-box-simple text-center">
                                <i class="icon-earphones-alt text-white border-white"></i>

                                <div class="feature-box-content">
                                    <h3 class="m-b-1">Customer Support</h3>
                                    <h5 class="m-b-3 text-white">Need Assistance?</h5>

                                    <p class="text-white">We provide 24/7 customer support and assistance.</p>
                        ...
                        <div class="col-md-4">
                            <div class="feature-box px-sm-3 feature-box-simple text-center">
                                <i class="icon-credit-card text-white border-white"></i>

                                <div class="feature-box-content">
                                    <h3 class="m-b-1">Secured Payment</h3>
                                    <h5 class="m-b-3 text-white">Safe & Fast</h5>

                                    <p class="text-white">Easy and convinient payment options.</p>
                                </div><!-- End .feature-box-content -->
                            </div><!-- End .feature-box -->
                        </div><!-- End .col-md-4 -->

                        <div class="col-md-4 text-white">
                            <div class="feature-box px-sm-3 feature-box-simple text-center text-white">
                                <i class="icon-action-undo text-white border-white"></i>

                                <div class="feature-box-content">
                                    <h3 class="m-b-1">Orders and Bookings</h3>
                                    <h5 class="m-b-3 text-white">Easy & Available</h5>

                                    <p class="text-white">Make an order or a booking anytime anywhere.</p>
                                </div><!-- End .feature-box-content -->
                            </div><!-- End .feature-box -->
                        </div><!-- End .col-md-4 -->
                    </div><!-- End .row -->
                ...
                <div class="side-menu-wrapper text-uppercase mb-2 d-none d-lg-block">
                    ...
                    <nav class="side-nav">
                        <ul class="menu menu-vertical sf-arrows">
                            ...
                            <li>
                                <a href="#" class="sf-with-ul text-black" style="color: black"> <i class="sicon-badge"></i>Services</a>
                            ...
                            <li>
                                <a href="#" class="sf-with-ul" style="color: black"><i class="sicon-basket"></i>Products</a>
                            ...
                            <li>
                                <a href="#" class="sf-with-ul" style="color: black"><i class="sicon-users"></i>My Account</a>
                                <ul>
                                    @if (Session::has('cart'))
                            ...
                            <li><a href="{{route('about')}}" style="color: black"><i class="sicon-book-open"></i>About Us</a></li>
