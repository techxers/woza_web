        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-8">
                    ...
                    <form action="{{route('rescheduled',$service->id)}}" method="POST" class="contact-form mb-3">
                       @csrf
                        <div class="row">
                            <div class="col-sm-12">
                                <label for="cname" class="">Service Date</label>
                                <input type="date" name="date" class="form-control" id="cname" value="{{$booking->service_date}}" placeholder="Name *" required>
                            </div><!-- End .col-sm-6 -->

                            <div class="col-sm-12">
                                <label for="cemail" class="">Service Time</label>
                                <input type="time" name="time" class="form-control" id="cemail" value="{{$booking->service_time}}" placeholder="Email *" required>
                            </div><!-- End .col-sm-6 -->
                        </div><!-- End .row -->

                        <label for="cmessage" class="">Description</label>
                        <textarea name="description" class="form-control" cols="30" rows="4" id="cmessage" required placeholder="Service Description*">{{$booking->description}}</textarea>
                        @guest
